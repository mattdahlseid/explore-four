...
function DesignationSelector (props) {
    return (
        ...
        <select className="designation-selector" tabIndex={props.sideBarVisible ? "0" : "-1" } aria-label="Sort by Designation" onChange={(event) => props.filterByDesignation(event.target.value)} defaultValue="Select All" key={props.timestamp} >
